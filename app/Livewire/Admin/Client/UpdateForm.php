...
use App\Models\Client as Award;
...
class UpdateForm extends Component
{
    ...
    {
        return view('livewire.admin.client.update-form');
    }
    ...
    function removeImage(Award $imageId){
        ...
        \Image::removeFile('clients/', $imageId->image);
        $imageId->delete();
        $this->getImages();
    ...
    function uploadImages(){
        ...
        if (is_array($this->images)) {
            foreach ($this->images as $k => $image) {
                $imageName = \Image::autoheight('clients/',$image);
                $imageData = new Award();
    ...
    function getImages(){
        $this->preimages = Award::orderBy('sequence','ASC')->get();
    }
