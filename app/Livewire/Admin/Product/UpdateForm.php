...
class UpdateForm extends Component
{
    ...
    {
        $this->productimages = \App\Models\ProductImage::product($this->info->id)->get();
    }
    public function setPrimaryImage(ProductImage $imageId)
    {
        ProductImage::product($this->info->id)->whereNot('id', $imageId->id)->update(['is_primary' => 0]);
