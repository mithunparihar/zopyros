                                        ...
                                        if (this._hasControls("themes")) {
                                            ...
                                            if (s) {
                                                ...
                                                this._loadStylesheets(
                                                    ...
                                                    (n = g(n)) in a ? Object.defineProperty(a, n, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (a[n] = o),
                                                    a),
                                                    i || function () {}
                                                ),
                                    ...
                                    value: function (t) {
                                        ...
                                        if (this._hasControls("headerType") && ("static" === t || "static-offcanvas" === t || "fixed" === t || "fixed-offcanvas" === t)) {
                                            ...
                                            "fixed" === this.settings.headerType || "fixed-offcanvas" === this.settings.headerType
                                                ? s && i && (window.Helpers.menuPsScroll.destroy(), (i = new s(document.querySelector(".menu-inner"), { suppressScrollX: !0, wheelPropagation: !1 })), (window.Helpers.menuPsScroll = i))
                                                : i && window.Helpers.menuPsScroll.destroy();
                                        }
                                    },
                                },
                                {
                                        ...
                                        if (!this._ssr) {
                                            ...
                                            this._controls.showDropdownOnHover &&
                                                ...
                                                this._controls.layoutNavbarOptions &&
                                                    ...
                                                    i && t && "fixed" === this.settings.headerType && (this._controls.layoutNavbarOptions.setAttribute("disabled", "disabled"), this._controls.layoutNavbarOptionsW.classList.add("disabled"))),
                                    ...
                                    value: function () {
                                                ...
                                                return (
                                                    ...
                                                    t._getElementFromString(
                                                        '<div class="col-4 px-2">\n      <div class="form-check custom-option custom-option-icon mb-0">\n        <label class="form-check-label custom-option-content p-0" for="'
                                                            ...
                                                            .concat(n)
                                                            .concat(a ? "-dark" : "", '.svg" alt="')
                                                            .concat(i, '" class="img-fluid scaleX-n1-rtl" />\n          </span>\n          <input\n            name="')
                                                            .concat(s, '"\n            class="form-check-input d-none"\n            type="radio"\n            value="')
                                                            .concat(e, '"\n            id="')
                                                            .concat(s)
                                                            .concat(e, '" />\n        </label>\n      </div>\n      <label class="form-check-label small text-nowrap" for="')
                                                            .concat(s)
                                                            .concat(e, '">')
                                                            .concat(i, "</label>\n    </div>")
                                                    )
                                        ...
                                        setTimeout(function () {
                                            ...
                                            document.querySelector(".menu-vertical")
                                                ? t._hasControls("rtl contentLayout layoutCollapsed layoutNavbarOptions", !0) || (e && e.parentNode.removeChild(e))
                                                : document.querySelector(".menu-horizontal") && (t._hasControls("rtl contentLayout headerType", !0) || (e && e.parentNode.removeChild(e)));
                                        }, 100),
                                ...
                                },
                                {
                                    ...
                                    value: function (t, e) {
                                        ...
                                        function n(t, e, i) {
                                            ...
                                            var a,
                                                n = "sheet" in s ? "sheet" : "styleSheet",
                                                o = "sheet" in s ? "cssRules" : "rules",
