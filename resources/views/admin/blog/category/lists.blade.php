...
@section('metatitle', 'Blog Category : ' . \Content::ProjectName())
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                <x-admin.button.back />
                <x-admin.button.add-more :href="route('admin.blog-category.create')" icon="fas fa-plus">Add More</x-admin.button.add-more>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
...
@push('js')
    ...
    <script>
        const tableListUrl = @json(route('admin.blog-category.index'));
        const removeRecordUrl = @json(route('admin.blog-category.remove'));
