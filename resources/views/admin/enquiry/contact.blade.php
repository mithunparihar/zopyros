...
@section('metatitle', 'Contact Enquiry : ' . \Content::ProjectName())
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center">
            <h4 class="fw-bold">Contact Enquiry </h4>
            <div class="d-flex gap-2"> </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <form method="POST" action="{{ route('admin.enquiry.contact.bulkdestroy') }}"  class="bulkForm card-body p-0">
                        @csrf
...
@push('js')
    ...
    <script>
        const tableListUrl = @json(route('admin.enquiry.contact'));
        const removeRecordUrl = @json(route('admin.enquiry.contact.remove'));
