...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <form method="POST" action="{{ route('admin.enquiry.quote.bulkdestroy') }}"  class="bulkForm card-body p-0">
                        @csrf
...
@push('js')
    ...
    <script>
        const tableListUrl = @json(route('admin.enquiry.quote',['type'=>request('type')]));
        const removeRecordUrl = @json(route('admin.enquiry.quote.remove'));
