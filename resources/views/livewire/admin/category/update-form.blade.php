        ...
        <div class="row">
            ...
            <div class="mb-1 col-md-12">
                ...
                <x-admin.form.input name="alias" wire:model="alias" type="text"
                    placeholder='Enter Alias/Slug Here...' @class(['otherValidation', 'is-invalid' => $errors->has('alias')]) />
                @error('alias')
                    <x-admin.form.invalid-error>{{ $message }}</x-admin.form.invalid-error>
                @enderror
            </div>
    ...
    <div class="card position-relative p-3 mt-2">
        <div class="row">
            <div class="col-4 mt-3">
                <x-admin.form.label for="formFile" class="formFile form-label" :asterisk="true">Best Image 1000px *
                    1000px</x-admin.form.label>
            ...
            <div class="col-2 mt-3">
                @if ($image)
                    ...
                    @endif
                @else
                    <x-image-preview class="defaultimg" width="200" imagepath="categories" :image="$info->image" />
                @endif
            </div>
