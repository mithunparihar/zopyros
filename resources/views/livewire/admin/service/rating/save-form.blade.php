<form class="pt-0 row g-2" wire:submit.prevent="SaveForm" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="mb-2 col-md-12">
            <x-admin.form.label for="title" class="form-label" :asterisk="true" title="Service" />
        ...
        <div class="col-md-3 mt-2">
            <div wire:ignore class="col-md d-flex mt-2 flex-column align-items-center justify-content-center">
                ...
                <div class=" counter-wrapper">
                    <span class="fw-medium">Rating <span class="text-danger">*</span> :</span>
        ...
        <div wire:loading.remove wire:target="images" class="row">
            ...
            @else
                <div class="col-2 my-3">
                    <x-image-preview :options="['class' => 'defaultimg', 'id' => 'blah']" imagepath="" image="" />
                </div>
            @endif
        </div>
        <x-admin.form.save-button buttonName="{{ \App\Enums\ButtonText::SAVE }}" target="images" />
    </div>
...
@push('js')
    ...
    <script>
        ...
        Livewire.on('removeRating', () => {
            $(".onChange-event-ratings").rateYo("destroy").removeData("rateYo");
            $(".counter").text(0);
            generateRating();
        })
    </script>
