<form class="pt-0 g-2" wire:submit.prevent="SaveForm" enctype="multipart/form-data">
    ...
    <div class="card p-3 mt-2">
        <div class="row">
            <div class="mb-2 col-md-12">
                <x-admin.form.label for="title" class="form-label" :asterisk="true" title="Service Name" />
                <x-admin.form.input name="title" type="text" :options="['placeholder' => 'Enter Service Name Here...', 'class' => 'otherValidation']" />
            ...
            <div class="col-md-12 mt-2">
                ...
                <x-admin.form.text-editor name="description" :editorOptions="['id' => 'summernote', 'value' => $description]" />
            ...
            <div class="col-md-12 mt-2">
                ...
                <x-admin.form.text-editor name="description2" :editorOptions="['id' => 'summernote2', 'value' => $description2]" />
    ...
    {{-- <div class="card mt-3 position-sticky  bottom-0" style="box-shadow:0 -4px 6px -6px rgb(0 0 0/.3);">
        <div class="row">
            <div class="col-12">
                <x-admin.form.save-button className="py-3 text-center" buttonName="{{ \App\Enums\ButtonText::SAVE }}"
                    target="images" />
            </div>
        </div>
    </div> --}}

    <x-admin.form.save-button className="py-3 text-end" buttonName="{{ \App\Enums\ButtonText::SAVE }}"
                    target="images" />
